...
if ! cd /var/www/modern-portfolio; then
    echo "ERROR: /var/www/modern-portfolio directory not found"
    exit 1
fi
...
if pm2 restart modern-portfolio 2>/dev/null; then
...
if ! pm2 list | grep -q "modern-portfolio.*online"; then
